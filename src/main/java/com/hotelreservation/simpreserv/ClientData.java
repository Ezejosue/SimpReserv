...
public class ClientData {
    ...
    public List<Client> clientList(){
      ...
      List<Client> list=new ArrayList<>();
        ...
        Client client=new Client("Jose","Martinez",new Date(),"Masculino","2385","C/4ra #2","829-340-5680","aol@gm.com",null,cc);
        list.add(client);
        Client client2=new Client("Miguel","Perez",new Date(),"Masculino","2548","C/5ra #3","829-340-541","aol2@gm.com",mn2,cc2);
        list.add(client2);
